    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <p className={styles.subtitle}>
          Compete in quiz battles, earn points, and<br />
          redeem them for amazing rewards!
        </p>
        <Link href="/quiz/select" className={styles.ctaButton}>
        ...
        <div className={styles.features}>
          <div className={styles.feature}>
            ...
            <h3>Battle</h3>
            <p>Challenge others<br />in exciting quizzes</p>
          </div>
          ...
          <div className={styles.feature}>
            ...
            <h3>Earn</h3>
            <p>Gain points for<br />each victory</p>
          </div>
          ...
          <div className={styles.feature}>
            ...
            <h3>Redeem</h3>
            <p>Trade points for<br />courses and more</p>
          </div>
        </div>
      </main>
    </div>
